...
* *Code contributed*: [https://nuscs2113-ay1819s1.github.io/dashboard/#=undefined&search=jeremyinelysium&sort=displayName&since=2018-09-12&until=2018-11-05&timeframe=day&reverse=false&repoSort=true[Functional/Test code]]
...
include::../UserGuide.adoc[tag=add_tag]

include::../UserGuide.adoc[tag=remove_tag]
